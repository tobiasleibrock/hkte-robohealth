...
function TooltipContent({
  ...
  return (
    <TooltipPrimitive.Portal>
      ...
      >
        {children}
        <TooltipPrimitive.Arrow className="z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px] bg-oklch(0.145 0 0) fill-foreground dark:bg-oklch(0.985 0 0)" />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  )
}
